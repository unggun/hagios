...
Route::get('/admin', array('as' => 'login', 'uses' => 'HomeController@showLogin'));	

Route::post('/admin/login', array('as' => 'doLogin', 'uses' => 'HomeController@doLogin'));
...
{
	Route::get('/logout', array('as' => 'doLogout' ,'uses' => 'HomeController@doLogout'));
